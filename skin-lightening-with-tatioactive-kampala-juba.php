...
$pageTitle = "Skin Lightening with <i class='text-brand font-light'>Tatioactive.</i>";
$pageDescription = "A premium skin lightening IV therapy with Tatioactive to achieve a brighter, more even complexion safely.";
            ...
            <div class="grid xl:grid-cols-2 gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        This advanced IV infusion utilizes Tatioactive, a powerful formulation of glutathione and skin-enhancing vitamins, to naturally lighten the skin, reduce pigmentation, and deliver a radiant glow.
                    </p>
                    ...
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[4/3] lg:aspect-auto lg:h-[450px] gs-reveal-img-group group border border-brand/5">
                        ...
                        <img src="/assets/images/services/iv-therapy/IV-Therapy_09.png" alt="Skin Lightening IV Therapy at Refine Skin and Body Clinic." class="w-full h-full object-cover gs-reveal-img filter grayscale-[0.2] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" loading="lazy">
                    </div>
                </div>
