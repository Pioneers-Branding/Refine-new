...
$pageTitle = "Joint & Tissue Rejuvenation in Kampala";
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I had the most amazing experience getting a <strong class="text-brand font-semibold">Joint & Tissue Rejuvenation in Kampala</strong> at Refine Clinic. The staff is professional, and the results are truly life-changing!
                            </h4>
