...
$pageTitle = "Medical Weight Loss Solutions in Kampala & Juba | Refine Clinic";
$pageDescription = "Experience physician-led weight loss at Refine Clinic. Allurion Gastric Balloon, Semaglutide / Ozempic®, and Gastric Sleeve Consultations.";
$metaTitle = "Medical Weight Loss & Allurion Balloon in Kampala | Refine Clinic";
$metaDescription = "Achieve sustainable weight loss with physician-supervised Allurion Swallowable Balloon, Semaglutide injections & Metabolic Wellness in Kampala & Juba.";
$canonicalUrl = "https://refineskinandbody.com/weight-loss";
$metaKeywords = "Weight Loss Kampala, Allurion Balloon Uganda, Semaglutide Kampala, Ozempic Uganda, Gastric Sleeve Uganda";
?>
...
<main>
    ...
    <section class="relative min-h-[80vh] lg:min-h-[760px] w-full flex items-center justify-center overflow-hidden pt-24 pb-16 bg-brand-deeper text-white">
        ...
        <div class="absolute inset-0 z-0">
            <img src="/assets/imagesfromsite/Gastric Sleeve and Bypass-09.png" alt="Weight Loss Banner" class="w-full h-full object-cover object-center filter brightness-[0.40] contrast-[1.1] scale-105 transform translateZ(0)">
            ...
            <div class="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                ...
                <div class="lg:col-span-7 text-left flex flex-col items-start pr-0 lg:pr-6">
                    ...
                    <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-lg mb-6">
                        ...
                        <span class="text-white font-body text-[11px] tracking-[0.2em] uppercase font-semibold">Medical Weight Loss Clinic</span>
                    </div>

                    <!-- Main Headline -->
                    <h1 class="font-display text-4xl md:text-5xl lg:text-6xl leading-[1.1] mb-6 drop-shadow-lg">
                        Transform Body. <br/>
                        <i class="bg-clip-text text-transparent bg-gradient-to-r from-accent-cream via-accent to-accent-light font-light">Sustained Vitality.</i>
                    </h1>

                    <!-- Short Description -->
                    <p class="font-body text-base md:text-lg text-white/80 font-light leading-relaxed max-w-md">
                        Physician-managed Allurion Gastric Balloon, Semaglutide (Ozempic®), and Clinical Weight Loss Programs.
                    </p>
                </div>
                ...
                <div class="lg:col-span-5 w-full">
                    <div class="glass-panel p-6 sm:p-8 rounded-3xl bg-brand-deeper/85 backdrop-blur-2xl border border-white/15 shadow-[0_20px_50px_rgba(0,0,0,0.35)] relative overflow-hidden">
                        ...
                        <div class="relative z-10 mb-6">
                            ...
                            <h3 class="font-display text-2xl text-white">Book Weight Loss Assessment</h3>
                            <p class="text-white/60 text-xs font-light mt-1">Schedule your consultation with our medical specialists today.</p>
                        </div>
                        ...
                        <form accept-charset="UTF-8" action="https://app.formester.com/forms/9f739eec-3fbd-49bf-a7a9-ebf490069756/submissions" method="POST" class="relative z-10 space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div>
                                    <label for="hero-treatment" class="block text-white/70 text-[11px] tracking-wider uppercase mb-1 font-medium">Program *</label>
                                    <select id="hero-treatment" name="treatment_interest" required class="w-full bg-[#1a0f3c] border border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-accent transition-all">
                                        <option value="allurion_balloon" selected class="bg-[#1a0f3c]">Allurion Gastric Balloon</option>
                                        <option value="semaglutide" class="bg-[#1a0f3c]">Semaglutide / Ozempic® Program</option>
                                        <option value="gastric_sleeve" class="bg-[#1a0f3c]">Bariatric Surgery Consultation</option>
                                        <option value="nutrition" class="bg-[#1a0f3c]">Clinical Nutrition Counseling</option>
                                    </select>
                                </div>
                            </div>
    ...
    <!-- ============================================
         SCIENCE OF METABOLIC WEIGHT LOSS
         ============================================ -->
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid xl:grid-cols-12 gap-12 lg:gap-16 items-center mb-16">
                <div class="xl:col-span-6">
                    <span class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand/5 border border-brand/10 text-accent font-body text-xs tracking-[0.25em] uppercase font-semibold mb-4">
                        Clinical Metabolic Science
                    </span>
                    <h2 class="text-section font-display text-brand-deeper leading-tight mb-6">
                        Sustainable Weight Loss <br/><i class="text-accent font-light">Without Starvation</i>
                    </h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed">
                        Combining swallowable gastric balloon technology, GLP-1 appetite regulation, and certified clinical nutrition counseling to reset your body's metabolic set-point.
                    </p>
                </div>
                <div class="xl:col-span-6">
                    <div class="p-8 rounded-3xl bg-white border border-brand/5 shadow-md">
                        <p class="text-brand-deeper font-body text-base font-light leading-relaxed italic mb-4">
                            "The Allurion Program allows patients to lose an average of 10-15% of their total body weight in 16 weeks without undergoing surgery, endoscopy, or anesthesia."
                        </p>
                        <span class="text-xs uppercase tracking-widest text-accent font-semibold">— Ms. Wendy Emyedu Ayayo, Lead Nutritionist</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="glass-panel p-8 rounded-3xl bg-white border border-brand/5 shadow-sm hover:shadow-xl transition-all duration-500">
                    ...
                    <h4 class="font-display text-xl text-brand-deeper mb-3">Swallowable Balloon Tech</h4>
                    <p class="text-brand-muted text-xs leading-relaxed font-light">Swallow a small vegan capsule filled with water during a 15-minute appointment to create a feeling of fullness.</p>
                </div>
                <div class="glass-panel p-8 rounded-3xl bg-white border border-brand/5 shadow-sm hover:shadow-xl transition-all duration-500">
                    <div class="w-12 h-12 rounded-2xl bg-accent/10 text-accent flex items-center justify-center text-xl font-bold mb-6">2</div>
                    <h4 class="font-display text-xl text-brand-deeper mb-3">GLP-1 Appetite Control</h4>
                    <p class="text-brand-muted text-xs leading-relaxed font-light">Semaglutide medical injections mimic natural satiety hormones, slowing gastric emptying and removing hunger spikes.</p>
                </div>
                <div class="glass-panel p-8 rounded-3xl bg-white border border-brand/5 shadow-sm hover:shadow-xl transition-all duration-500">
                    <div class="w-12 h-12 rounded-2xl bg-accent/10 text-accent flex items-center justify-center text-xl font-bold mb-6">3</div>
                    <h4 class="font-display text-xl text-brand-deeper mb-3">Metabolic Behavior Shift</h4>
                    <p class="text-brand-muted text-xs leading-relaxed font-light">Continuous medical tracking with smart scales & nutritionist coaching ensures weight loss is maintained long-term.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-14">
                <div>
                    ...
                    <h2 class="text-section font-display text-brand-deeper leading-tight">
                        Weight Loss <i class="bg-clip-text text-transparent bg-gradient-to-r from-brand to-brand-light font-light">Programs</i>
                    </h2>
                </div>
                <p class="text-brand-muted font-body text-sm font-light leading-relaxed max-w-md">
                    Targeted non-surgical gastric balloons, GLP-1 weight loss injections, and surgical consultations.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group rounded-3xl bg-[#faf9f6] border border-brand/5 overflow-hidden shadow-sm hover:shadow-2xl hover:border-accent/30 transition-all duration-500 flex flex-col justify-between">
                    <div class="relative h-64 overflow-hidden bg-brand-pale">
                        <img src="/assets/imagesfromsite/Gastric Sleeve and Bypass-09.png" alt="Allurion Swallowable Balloon" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-brand-deeper/80 via-transparent to-transparent"></div>
                        <span class="absolute top-4 left-4 px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-[10px] uppercase tracking-widest text-white font-semibold">Swallowable Balloon</span>
                    </div>
                    <div class="p-8 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-display text-2xl text-brand-deeper mb-3">Allurion Gastric Balloon</h3>
                            <p class="text-brand-muted text-sm font-light leading-relaxed mb-6">
                                The world's first swallowable gastric balloon. Requires zero surgery, endoscopy, or anesthesia. Lose 10-15% body weight in 16 weeks.
                            </p>
                        </div>
                        <div class="pt-4 border-t border-brand/5 flex items-center justify-between">
                            <span class="text-xs text-brand-muted">Duration: 16 Weeks</span>
                            <a href="/allurion-weight-loss" class="inline-flex items-center gap-2 text-accent font-semibold text-xs uppercase tracking-wider group-hover:gap-3 transition-all">
                ...
                <div class="group rounded-3xl bg-[#faf9f6] border border-brand/5 overflow-hidden shadow-sm hover:shadow-2xl hover:border-accent/30 transition-all duration-500 flex flex-col justify-between">
                    <div class="relative h-64 overflow-hidden bg-brand-pale">
                        <img src="/assets/imagesfromsite/Glutathione-9.png" alt="Semaglutide Ozempic Therapy" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-brand-deeper/80 via-transparent to-transparent"></div>
                        <span class="absolute top-4 left-4 px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-[10px] uppercase tracking-widest text-white font-semibold">Appetite Control</span>
                    </div>
                    <div class="p-8 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-display text-2xl text-brand-deeper mb-3">Semaglutide (Ozempic®) Therapy</h3>
                            <p class="text-brand-muted text-sm font-light leading-relaxed mb-6">
                                Physician-monitored weekly GLP-1 injections to curb food cravings, manage blood sugar, and lose visceral fat steadily.
                            </p>
                        </div>
                        <div class="pt-4 border-t border-brand/5 flex items-center justify-between">
                            <span class="text-xs text-brand-muted">Weekly Injection Protocol</span>
                            <a href="/semaglutide-ozempic-weight-loss" class="inline-flex items-center gap-2 text-accent font-semibold text-xs uppercase tracking-wider group-hover:gap-3 transition-all">
                                Explore <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="group rounded-3xl bg-[#faf9f6] border border-brand/5 overflow-hidden shadow-sm hover:shadow-2xl hover:border-accent/30 transition-all duration-500 flex flex-col justify-between">
                    <div class="relative h-64 overflow-hidden bg-brand-pale">
                        <img src="/assets/imagesfromsite/Gastric Sleeve and Bypass-09.png" alt="Bariatric Surgery" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="absolute inset-0 bg-gradient-to-t from-brand-deeper/80 via-transparent to-transparent"></div>
                        <span class="absolute top-4 left-4 px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-[10px] uppercase tracking-widest text-white font-semibold">Bariatric Surgery</span>
                    </div>
                    <div class="p-8 flex-1 flex flex-col justify-between">
                        <div>
                            <h3 class="font-display text-2xl text-brand-deeper mb-3">Gastric Sleeve & Bypass</h3>
                            <p class="text-brand-muted text-sm font-light leading-relaxed mb-6">
                                Comprehensive surgical consultations for laparoscopic gastric sleeve and bypass operations with top bariatric surgeons.
                            </p>
                        </div>
                        <div class="pt-4 border-t border-brand/5 flex items-center justify-between">
                            <span class="text-xs text-brand-muted">Permanent Transformation</span>
                            <a href="/gastric-sleeve-and-bypass-surgery" class="inline-flex items-center gap-2 text-accent font-semibold text-xs uppercase tracking-wider group-hover:gap-3 transition-all">
                                Explore <i class="fas fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
