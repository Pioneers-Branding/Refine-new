...
$pageTitle = "Glutathione <i class='text-brand font-light'>Therapy.</i>";
$pageDescription = "The ultimate detox and skin lightening IV drip — packed with high-dose glutathione for a brighter, more even complexion and a rejuvenated body.";

$metaTitle = "Inner Beauty IV Therapy | Refine Skin & Body Clinic";
$metaDescription = $pageDescription;
?>
<?php $canonicalUrl = "https://refineskinandbody.com/glutathione-iv-therapy-in-nansana";
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/glutathione-iv-therapy" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Glutathione IV Therapy</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Nansana Location</span>
            </div>
            <a href="/glutathione-iv-therapy" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Glutathione IV Therapy Page</span>
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="text-section font-display text-brand-deeper mb-6 leading-[1.1]">What is <br/><i class="text-accent font-light">Glutathione IV Therapy?</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        Our formula infuses pure glutathione, the master antioxidant, directly into the bloodstream to detoxify your liver, neutralize free radicals, and naturally lighten and brighten your skin.
                    </p>
                    ...
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[16/10] sm:aspect-[4/3] w-full max-w-xl lg:max-w-none mx-auto gs-reveal-img-group group border border-brand/5">
                        ...
                        <img src="/assets/images/services/iv-therapy/IV-Therapy_09.png" alt="Inner Beauty Iv Therapy at Refine Skin and Body Clinic." class="w-full h-full object-cover gs-reveal-img filter grayscale-[0.2] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" loading="lazy">
                    </div>
                </div>
