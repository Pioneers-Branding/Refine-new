...
$canonicalUrl = "https://refineskinandbody.com/aftercare-in-nansana";
?>
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/aftercare" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Aftercare</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Nansana Location</span>
            </div>
            <a href="/aftercare" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Aftercare Page</span>
