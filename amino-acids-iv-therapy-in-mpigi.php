...
$pageTitle = "Amino Acids <i class='text-brand font-light'>Therapy.</i>";
$pageDescription = "A potent blend of essential amino acids for muscle recovery, enhanced performance, and optimal cellular function.";

$metaTitle = "Inner Beauty IV Therapy | Refine Skin & Body Clinic";
$metaDescription = $pageDescription;
?>
<?php $canonicalUrl = "https://refineskinandbody.com/amino-acids-iv-therapy-in-mpigi";
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/amino-acids-iv-therapy" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Amino Acids IV Therapy</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Mpigi Location</span>
            </div>
            <a href="/amino-acids-iv-therapy" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Amino Acids IV Therapy Page</span>
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="text-section font-display text-brand-deeper mb-6 leading-[1.1]">What is <br/><i class="text-accent font-light">Amino Acids IV Therapy?</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        This specialized drip delivers building blocks of protein directly to your cells, promoting faster recovery after workouts, improving stamina, and supporting overall wellness.
                    </p>
