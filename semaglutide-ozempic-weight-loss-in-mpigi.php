...
$pageTitle = "Semaglutide & Ozempic Weight Loss in Mpigi";
...
$metaTitle = "Semaglutide / Ozempic Weight Loss Treatment in Mpigi | Refine Clinic";
$metaDescription = "Seeking semaglutide / ozempic weight loss treatment in Mpigi? Refine Skin & Body Clinic offers advanced treatments to deeply cleanse, hydrate, and rejuvenate your skin.";
$canonicalUrl = "https://refineskinandbody.com/semaglutide-ozempic-weight-loss-in-mpigi";
$metaKeywords = "Semaglutide / Ozempic Weight Loss in Mpigi, Semaglutide / Ozempic Weight Loss treatment in Kampal";
?>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I had the most amazing experience getting a <strong class="text-brand font-semibold">Semaglutide & Ozempic Weight Loss in Mpigi</strong> at Refine Clinic. The staff is professional, and the results are truly life-changing!
                            </h4>
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Best <strong class="text-brand font-semibold">Semaglutide / Ozempic Weight Loss treatment in Mpigi</strong> by far! The clinic is beautiful, and the specialists are so supportive and knowledgeable.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Absolutely loved my <strong class="text-brand font-semibold">Semaglutide / Ozempic Weight Loss treatment in Mpigi</strong>! The specialists guided me through every step, and the progress has exceeded my expectations.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I feel incredibly healthy and happy. This was my first experience with <strong class="text-brand font-semibold">Semaglutide / Ozempic Weight Loss in Mpigi</strong>, and the results exceeded my expectations. Highly recommend!
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Refine is the absolute best for <strong class="text-brand font-semibold">Semaglutide / Ozempic Weight Loss in Mpigi</strong>. The clinic uses state-of-the-art technology, and their customized plan made all the difference.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
  ...
  <section class="py-16 lg:py-24 bg-[#faf9f6]">
    <div class="max-w-[900px] mx-auto px-6">
      ...
      <div class="space-y-3">
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">6. What is the cost of Semaglutide Ozempic Weight Loss in Mpigi?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
