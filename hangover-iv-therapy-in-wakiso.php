...
$pageTitle = "Hangover <i class='text-brand font-light'>Relief.</i>";
$pageDescription = "Fast-acting IV therapy to cure hangover symptoms, rehydrate, and replenish lost nutrients.";

$metaTitle = "Inner Beauty IV Therapy | Refine Skin & Body Clinic";
$metaDescription = $pageDescription;
?>
<?php $canonicalUrl = "https://refineskinandbody.com/hangover-iv-therapy-in-wakiso";
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/hangover-iv-therapy" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Hangover IV Therapy</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Wakiso Location</span>
            </div>
            <a href="/hangover-iv-therapy" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Hangover IV Therapy Page</span>
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        A rapid recovery infusion containing fluids, electrolytes, anti-nausea medication, and vitamins to eliminate headaches and fatigue after a night out.
                    </p>
