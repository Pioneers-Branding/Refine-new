    ...
    <div class="max-w-[1600px] mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div class="grid lg:grid-cols-12 gap-10 lg:gap-16 pb-12 lg:pb-16 border-b border-white/10">
            <div class="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <p class="text-white/55 font-body text-sm font-light leading-relaxed max-w-xl mb-8">
                    From advanced skin rejuvenation and hair restoration to medical weight loss and IV therapy — we blend world-class technology with the artistry of personalised care, across four locations in Bukoto and Juba.
                </p>
                ...
                <div class="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                    ...
                    <a href="https://www.tiktok.com/discover/refine-skin-and-body-clinic-bukoto" target="_blank" class="w-10 h-10 rounded-full bg-white/5 hover:bg-accent text-white/70 hover:text-brand-deeper flex items-center justify-center transition-all" title="TikTok"><i class="fa-brands fa-tiktok"></i></a>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-8 py-16 border-b border-white/10">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="cosmetic-dermatology-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">All Cosmetic</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="anti-aging-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Anti-Aging</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="beard-transplant-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Beard Transplant</a></li>
                    <li><a href="eyebrow-transplant-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Eyebrow Transplant</a></li>
                    <li><a href="microblading-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Microblading</a></li>
                    <li><a href="body-contouring-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Body Contouring</a></li>
                    <li><a href="liposuction-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Liposuction</a></li>
                    <li><a href="mommy-makeover-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Mommy Makeover</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="refine-iv-lounge-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">IV Lounge Hub</a></li>
                    ...
                    <li><a href="mobile-iv-service-bukoto-juba" class="text-white/55 hover:text-accent text-sm font-light transition-colors">Mobile IV Service</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
            <p class="text-white/40 font-body text-xs">&copy; <?php echo date('Y'); $canonicalUrl = "https://refineskinandbody.com/old_footer-in-bukoto";
