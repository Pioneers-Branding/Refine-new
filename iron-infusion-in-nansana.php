...
$pageDescription = "Effective and safe intravenous iron replacement therapy for treating iron deficiency and anemia.";

$metaTitle = "Inner Beauty IV Therapy | Refine Skin & Body Clinic";
$metaDescription = $pageDescription;
?>
<?php $canonicalUrl = "https://refineskinandbody.com/iron-infusion-in-nansana";
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/iron-infusion" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Iron Infusion</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Nansana Location</span>
            </div>
            <a href="/iron-infusion" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Iron Infusion Page</span>
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="text-section font-display text-brand-deeper mb-6 leading-[1.1]">What is an <br/><i class="text-accent font-light">Iron Infusion?</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        A direct delivery of iron into your bloodstream to rapidly replenish depleted iron stores, boosting energy levels and resolving symptoms of anemia.
                    </p>
