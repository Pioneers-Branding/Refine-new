...
$canonicalUrl = "https://refineskinandbody.com/cookie-policy-in-kabalagala";
?>
                ...
                <div class="lg:col-span-9 glass-panel p-8 md:p-12 lg:p-16 rounded-[40px] bg-white shadow-xl border border-brand/5">
                    <div class="max-w-[800px] font-body text-brand-muted font-light leading-relaxed space-y-8">
                        ...
                        <ul class="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>Preference Cookies:</strong> These allow our website to remember choices you make, such as your preferred clinic branch (Kabalagala vs Juba) or language preferences.</li>
                        </ul>
