        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="gs-reveal-text">
                    <h2 class="font-display text-4xl text-brand-deeper mb-6">Lift Without <i class="text-accent font-light">Surgery.</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-8">
                        Plasma Pen therapy uses a controlled arc of plasma energy to instantly contract and tighten the skin's surface. It is one of the only non-invasive treatments capable of performing a true skin lift — perfect for areas where surgery was once the only option.
                    </p>
                    ...
                    <ul class="grid grid-cols-2 gap-x-4 gap-y-3 font-body text-brand-muted text-sm font-light">
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Upper & Lower Eyelids</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Crow's Feet</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Smoker's Lines</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Forehead Lines</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Neck & Décolletage</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Stretch Marks & Scars</li>
                    </ul>
                </div>
    ...
    <section class="py-16 lg:py-24 bg-white border-t border-brand/5">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div class="mb-12 gs-reveal-text text-center">
                <h3 class="font-display text-3xl text-brand-deeper">Plasma Pen <i class="text-accent font-light">Treatments</i></h3>
            </div>
            ...
            <div class="space-y-4">
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    <div class="p-6 flex justify-between items-center bg-white group-hover:bg-brand/5 transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-lg">How long does healing take?</h4>
                    ...
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300 bg-white">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">Small dots (carbon crusts) form immediately and fall off naturally in 5–7 days. Full skin remodeling continues for 8–12 weeks.</p>
                    </div>
                </div>
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    <div class="p-6 flex justify-between items-center bg-white group-hover:bg-brand/5 transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-lg">Is one session enough?</h4>
                        <i class="fas fa-plus text-brand transition-transform duration-300 transform group-[.active]:rotate-45"></i>
                    </div>
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300 bg-white">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">Most patients see significant results after one session, though 2–3 sessions spaced 8–12 weeks apart may be recommended for optimal outcomes.</p>
                    </div>
                </div>
            </div>
        </div>
