        ...
        <div class="max-w-[1150px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid xl:grid-cols-2 gap-10 xl:gap-16 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="font-display text-5xl lg:text-6xl text-brand-deeper mb-6 leading-[1.1]">What is <br/><i class="text-accent font-light">Dermal Filler in Kampala?</i></h2>
        ...
        <div class="max-w-[1100px] mx-auto px-6 lg:px-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)] gs-stagger-bento">
                ...
                <div class="md:col-span-2 group glass-panel p-6 lg:p-8 rounded-[2rem] bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 bento-item overflow-hidden relative">
                    ...
                    <p class="text-base text-brand-muted font-light leading-relaxed max-w-md relative z-10">Caused by the natural breakdown of collagen and elastin in the skin, as well as exposure to ultraviolet (UV) light.</p>
                </div>
                ...
                <div class="group glass-panel p-6 lg:p-8 rounded-[2rem] bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 bento-item relative">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3">Volume Loss</h4>
                    <p class="text-sm text-brand-muted font-light leading-relaxed">A natural part of aging where the face loses its fullness, often leading to hollowed cheeks and a saggy appearance.</p>
                </div>
                ...
                <div class="group glass-panel p-6 lg:p-8 rounded-[2rem] bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 bento-item relative">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3">Facial Contouring</h4>
                    <p class="text-sm text-brand-muted font-light leading-relaxed">Enhancing the natural contours of the face, such as the cheeks and jawline, for a more defined appearance.</p>
                </div>
                ...
                <div class="group glass-panel p-6 lg:p-8 rounded-[2rem] bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 bento-item relative">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3">Lip Augmentation</h4>
                    <p class="text-sm text-brand-muted font-light leading-relaxed">Increasing the fullness of the lips to improve appearance or to correct asymmetrical lips.</p>
                </div>
