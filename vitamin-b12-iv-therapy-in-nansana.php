...
$pageTitle = "B12 & B-Complex <i class='text-brand font-light'>Therapy.</i>";
$pageDescription = "An energizing blend of Vitamin B12 and B-Complex to combat fatigue, improve mood, and boost metabolism.";
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/vitamin-b12-iv-therapy" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Vitamin B12 IV Therapy</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Nansana Location</span>
            </div>
            <a href="/vitamin-b12-iv-therapy" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Vitamin B12 IV Therapy Page</span>
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid xl:grid-cols-2 gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="text-section font-display text-brand-deeper mb-6 leading-[1.1]">What is <br/><i class="text-accent font-light">B12 & B-Complex IV Therapy?</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        A targeted infusion of essential B vitamins that work synergistically to restore energy levels, enhance brain function, and support a healthy nervous system.
                    </p>
