...
$pageTitle = "Acne Treatment in Entebbe";
...
$metaTitle = "Acne Treatment in Entebbe | Refine Clinic";
$metaDescription = "Seeking experienced dermatologists for acne treatment in Entebbe? Refine Skin & Body Clinic offers advanced medical dermatology treatments.";
$canonicalUrl = "https://refineskinandbody.com/acne-in-entebbe";
$metaKeywords = "Acne Treatment in Entebbe, Acne Treatment treatment in Kampal";
?>
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/acne" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Acne</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Entebbe Location</span>
            </div>
            <a href="/acne" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Acne Page</span>
            ...
            <div class="grid xl:grid-cols-2 gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[4/3] lg:aspect-auto lg:h-[450px] gs-reveal-img-group group border border-brand/5">
                        ...
                        <img src="/assets/images/services/acne_and_scars/Acne.webp" alt="Acne Treatment at Refine Skin and Body Clinic." class="w-full h-full object-cover gs-reveal-img filter grayscale-[0.2] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" loading="lazy">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="space-y-8 relative z-10">
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">1.</span> Thorough Consultation
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">Deep dive into individual skin needs.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">2.</span> Comfortable Environment
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">Relaxing atmosphere during every procedure.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">3.</span> Trustworthy Hands
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">Rest assured under the care of Dr Kotecha.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">4.</span> Visible Results
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">Witness significant improvements in skin clarity.</p>
                            </div>
                        </div>
    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 gs-stagger-bento">
        ...
        <div class="md:col-span-2 group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 overflow-hidden relative cursor-pointer">
          ...
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Addressing Hormone-Induced Breakouts</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed max-w-3xl relative z-10">Focusing on the unique challenges of hormone-related acne. Our expert team utilizes advanced, evidence-based techniques to address this effectively. We personalize every step of the process to ensure optimal, long-lasting results that harmonize with your natural aesthetics and restore your confidence.</p>
        ...
        <div class="group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 relative cursor-pointer">
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Treating Inflammatory Acne</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed relative z-10">Effective solutions for pimples and papules.</p>
        ...
        <!-- 3 -->
        <div class="group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 relative cursor-pointer">
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Reducing Non-Inflammatory Acne</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed relative z-10">Targeting blackheads and whiteheads for a clearer complexion.</p>
        ...
        <!-- 4 -->
        <div class="group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 relative cursor-pointer">
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Minimising Cystic Acne and Nodules</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed relative z-10">Specialized treatments for severe acne forms.</p>
        ...
        <div class="md:col-span-2 lg:col-span-1 group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 relative cursor-pointer">
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Treating Acne-Induced Hyperpigmentation and Scarring</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed relative z-10">Advanced techniques to restore skin health and appearance.</p>
                    ...
                    <div class="glass-panel p-10 lg:p-12 rounded-[3rem] bg-[#1a2333]/60 backdrop-blur-2xl border border-white/10 shadow-2xl relative overflow-hidden h-full flex flex-col justify-center transform hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div class="space-y-8 relative z-10">
                            <div class="bg-white/5 p-6 rounded-3xl border border-white/5 shadow-inner">
                                ...
                                <p class="font-heading text-xl font-light text-white/80 italic">"Acne is caused by dirty skin."</p>
                            </div>
                            ...
                            <div class="bg-accent/10 p-6 rounded-3xl border border-accent/20 shadow-lg relative overflow-hidden">
                                ...
                                <p class="font-heading text-2xl font-light text-white relative z-10 leading-snug">Acne is often a result of hormones, genetics, or even certain medications.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-[1600px] mx-auto px-6 lg:px-10 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-20 gs-reveal-text">
                ...
                <p class="text-brand-muted font-body text-lg font-light leading-relaxed">
                    Discover why we are the top-rated clinic for Acne Treatment treatments. Here is what our patients say about their clinical dermatology journey with us.
                </p>
            </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I had the most amazing experience getting <strong class="text-brand font-semibold">Acne Treatment in Entebbe</strong> at Refine Clinic. My skin was deeply cleansed, and the glow was instant. Highly recommend their professional staff!
                            </h4>
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Best <strong class="text-brand font-semibold">Acne Treatment treatment in Entebbe</strong> in Entebbe! The dermatologists are highly experienced and the treatment plan actually works.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Absolutely loved my care during the <strong class="text-brand font-semibold">Acne Treatment treatment in Entebbe</strong>! The treatment was highly effective and the follow-ups were excellent.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                The ultimate clinic for clinical dermatology. The expertise of Dr. Chirag and the team is unmatched in Entebbe.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                My skin is completely clear and healthy. This was my first <strong class="text-brand font-semibold">Acne Treatment in Entebbe</strong>, and the results exceeded my expectations.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Refine is the absolute best clinic for <strong class="text-brand font-semibold">Acne Treatment in Entebbe</strong>. They use advanced clinical therapies and provide top-notch patient care.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
    ...
    <div class="max-w-[900px] mx-auto px-6">
      <div class="text-center mb-16">
        ...
        <p class="text-brand-muted font-body text-lg font-light leading-relaxed max-w-2xl mx-auto">
          Explore our comprehensive FAQ section for quick answers to common queries about Acne Treatment. Find the clarity you need without delay.
        </p>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">6. What is the cost of Acne Treatment in Entebbe?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
