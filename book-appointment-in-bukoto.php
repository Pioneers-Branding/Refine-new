...
$canonicalUrl = "https://refineskinandbody.com/book-appointment-in-bukoto";
?>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="relative">
                                            <select class="w-full bg-white border border-brand/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-accent appearance-none transition-colors cursor-pointer" required>
                                                ...
                                                <option value="bukoto-hq">Bukoto HQ (Forest Mall)</option>
                                                <option value="kabalagala">Bukoto (Kabalagala)</option>
                                                <option value="bukoto">Bukoto (Bukoto)</option>
