                        ...
                        <div class="mega-menu-panel p-8 grid grid-cols-6 gap-4 lg:gap-6 relative whitespace-normal">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <a href="/mounjaro" class="block text-xs lg:text-sm text-gray-600 hover:text-brand transition-colors">Mounjaro</a>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <a href="/plastic-surgery" class="block text-xs lg:text-sm text-gray-600 hover:text-brand transition-colors leading-tight font-medium text-brand">Plastic Surgery</a>
...
<aside id="mobile-menu" class="mobile-menu fixed top-0 right-0 h-full w-full max-w-[420px] bg-brand text-white z-[1001] shadow-2xl overflow-y-auto border-l border-white/10 translate-x-full">
    <div class="p-8 flex flex-col h-full">
        ...
        <nav class="flex-1 flex flex-col space-y-4 mobile-nav-links overflow-y-auto pr-2 pb-24">
            ...
            <details class="group border-b border-white/10 pb-3">
                ...
                <div class="mt-4 mb-2 space-y-5 pl-3 border-l-2 border-brand-light/20">
                    ...
                    <div>
                        ...
                        <a href="/mounjaro" class="block font-body text-sm text-white/80 py-1 hover:text-accent">Mounjaro</a>
                    ...
                    <div>
                        <p class="text-accent/80 text-[10px] tracking-wider uppercase font-semibold mb-2">Body Contouring & Surgery</p>
                        <a href="/plastic-surgery" class="block font-body text-sm text-white/80 py-1 hover:text-accent font-medium">Plastic Surgery</a>
            ...
            <a href="/blog" class="font-display italic text-xl py-3 text-white hover:text-accent border-b border-white/10">Blog</a>
