<!-- ============================================
     ...
     Interactive Accordion Section for Homepage
     ============================================ -->
<section id="faq-section" class="py-16 lg:py-24 bg-white relative overflow-hidden">
    <!-- Background Design Accents -->
    <div class="absolute top-0 left-1/4 w-96 h-96 bg-brand/5 rounded-full blur-3xl pointer-events-none -mt-20"></div>
    <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-accent/10 rounded-full blur-3xl pointer-events-none -mb-20"></div>

    <div class="max-w-[1200px] mx-auto px-6 lg:px-10 relative z-10">

        <!-- Section Header -->
        <div class="text-center max-w-3xl mx-auto mb-14 gs-reveal-text">
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand/5 border border-brand/10 mb-4">
                <span class="w-2 h-2 rounded-full bg-accent animate-pulse"></span>
                <span class="text-accent font-body text-[10px] tracking-[0.25em] uppercase font-semibold">Got Questions? We Have Answers</span>
            </div>
...
<!-- Vanilla JS for FAQ Accordion -->
<script>
document.addEventListener('DOMContentLoaded', () => {
    const faqItems = document.querySelectorAll('.faq-home-item');
    faqItems.forEach(item => {
        item.addEventListener('click', () => {
            ...
            faqItems.forEach(el => {
                ...
                const content = el.querySelector('.faq-home-content');
