        ...
        <div class="grid lg:grid-cols-12 gap-12 lg:gap-16 pb-16 border-b border-white/10">
            <div class="lg:col-span-7">
                <a href="/" class="inline-block mb-6">
                    <img src="/assets/images/refine-logo.png" alt="Refine Clinic Logo" class="h-12 w-auto object-contain">
                </a>
                ...
                <div class="flex items-center gap-3">
                    <span class="text-[10px] tracking-[0.3em] uppercase text-white/40 font-semibold mr-2">Follow</span>
            ...
            <div class="lg:col-span-5">
                <div class="glass-panel rounded-3xl p-7 lg:p-8 bg-white/[0.03] border border-white/10">
                    ...
                    <form class="flex gap-2" onsubmit="event.preventDefault(); this.querySelector('button').innerText='Subscribed ✓';">
                        <input type="email" required placeholder="your@email.com" class="flex-1 bg-white/5 border border-white/10 rounded-full px-5 py-3 text-sm text-white placeholder-white/30 focus:outline-none focus:border-accent transition-colors">
                        <button type="submit" class="btn-magnetic magnetic-target" style="padding: 12px 22px; font-size: 13px;"><span>Subscribe</span></button>
                    </form>
                    <p class="text-white/30 text-[10px] mt-3 leading-relaxed">By subscribing you agree to our <a href="cookie-policy" class="text-accent/70 hover:text-accent">Privacy Policy</a>. Unsubscribe anytime.</p>
                </div>
            </div>
        </div>
