...
<main class="pt-20">
    ...
    <section class="py-16 bg-white border-b border-brand/5">
        <div class="max-w-[1000px] mx-auto px-6 text-center gs-reveal-fade">
            <h2 class="font-display text-3xl text-brand-deeper mb-6">Beauty, From the <i class="text-accent font-light">Inside Out.</i></h2>
            <p class="text-brand-muted font-body text-lg font-light leading-relaxed">
                The Inner Beauty IV is our signature drip for radiant skin, strong nails, and shiny hair. A powerful blend of glutathione (the master antioxidant), biotin, Vitamin C, and B-complex nourishes your cells at the deepest level for a glow that no cream can match.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 lg:py-24 bg-surface-warm">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div class="mb-12 gs-reveal-text">
                <h3 class="font-display text-3xl text-brand-deeper">Beauty Drip <i class="text-accent font-light">Variants</i></h3>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 gs-stagger-bento">
                <a href="#" class="group block glass-panel p-6 rounded-3xl bg-white border border-brand/5 hover:border-accent/30 shadow-sm transition-all bento-item">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-lg mb-2 group-hover:text-accent transition-colors">Inner Beauty Classic</h4>
                    <p class="text-sm text-brand-muted font-light line-clamp-2">The original skin, hair, and nail formula with glutathione, biotin, and Vitamin C.</p>
                </a>
                ...
                <a href="glutathione-IV-therapy-kampala-juba" class="group block glass-panel p-6 rounded-3xl bg-white border border-brand/5 hover:border-accent/30 shadow-sm transition-all bento-item">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-lg mb-2 group-hover:text-accent transition-colors">Inner Beauty + Glutathione</h4>
                    <p class="text-sm text-brand-muted font-light line-clamp-2">A high-dose glutathione boost added to the beauty formula for extra brightening.</p>
                </a>
                ...
                <a href="vitamin-c-treatment-IV-therapy-treatment-kampala-juba" class="group block glass-panel p-6 rounded-3xl bg-white border border-brand/5 hover:border-accent/30 shadow-sm transition-all bento-item">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-lg mb-2 group-hover:text-accent transition-colors">Inner Beauty + Vitamin C</h4>
                    <p class="text-sm text-brand-muted font-light line-clamp-2">Add high-dose Vitamin C for collagen production and immune support.</p>
                </a>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-4">
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    <div class="p-6 flex justify-between items-center bg-white/50 group-hover:bg-white transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-lg">How often should I get the Inner Beauty IV?</h4>
                    ...
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">For best results, we recommend 1 drip per week for 4 weeks, then monthly maintenance.</p>
                    </div>
                </div>
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    <div class="p-6 flex justify-between items-center bg-white/50 group-hover:bg-white transition-colors">
                    ...
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">Most clients notice brighter, more hydrated skin within 24–48 hours, with cumulative glow over the following weeks.</p>
                    </div>
                </div>
            </div>
        </div>
