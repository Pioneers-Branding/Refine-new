            ...
            <div class="space-y-4">
                <details class="group bg-[#faf9f6] rounded-2xl p-6 border border-brand/5 [&amp;[open]]:bg-white [&amp;[open]]:shadow-lg transition-all duration-300">
                    <summary class="flex justify-between items-center font-heading font-semibold text-lg text-brand-deeper cursor-pointer list-none">
                        <span>How long does Microblading last?</span>
                        <span class="text-accent transition-transform duration-300 group-open:rotate-180"><i class="fas fa-chevron-down"></i></span>
                    </summary>
                    <p class="mt-4 text-brand-muted font-body text-sm font-light leading-relaxed">Microblading results typically last between 12 to 18 months depending on skin type, lifestyle, and sun exposure. An annual color boost touch-up is recommended to keep brows crisp and defined.</p>
                </details>

                <details class="group bg-[#faf9f6] rounded-2xl p-6 border border-brand/5 [&amp;[open]]:bg-white [&amp;[open]]:shadow-lg transition-all duration-300">
                    <summary class="flex justify-between items-center font-heading font-semibold text-lg text-brand-deeper cursor-pointer list-none">
                        <span>Is the Microblading procedure painful?</span>
                        <span class="text-accent transition-transform duration-300 group-open:rotate-180"><i class="fas fa-chevron-down"></i></span>
                    </summary>
                    <p class="mt-4 text-brand-muted font-body text-sm font-light leading-relaxed">Minimal discomfort is experienced. We apply a topical medical-grade numbing cream before and during the procedure to ensure the treatment is comfortable for you.</p>
                </details>

                <details class="group bg-[#faf9f6] rounded-2xl p-6 border border-brand/5 [&amp;[open]]:bg-white [&amp;[open]]:shadow-lg transition-all duration-300">
                    <summary class="flex justify-between items-center font-heading font-semibold text-lg text-brand-deeper cursor-pointer list-none">
                        <span>How long does the appointment take?</span>
                        <span class="text-accent transition-transform duration-300 group-open:rotate-180"><i class="fas fa-chevron-down"></i></span>
                    </summary>
                    <p class="mt-4 text-brand-muted font-body text-sm font-light leading-relaxed">A full microblading session takes approximately 2 hours. This includes comprehensive brow mapping, custom color selection, numbing, micro-blading, and aftercare review.</p>
                </details>

                <details class="group bg-[#faf9f6] rounded-2xl p-6 border border-brand/5 [&amp;[open]]:bg-white [&amp;[open]]:shadow-lg transition-all duration-300">
                    <summary class="flex justify-between items-center font-heading font-semibold text-lg text-brand-deeper cursor-pointer list-none">
                        <span>What is the healing process like?</span>
                        <span class="text-accent transition-transform duration-300 group-open:rotate-180"><i class="fas fa-chevron-down"></i></span>
                    </summary>
                    <p class="mt-4 text-brand-muted font-body text-sm font-light leading-relaxed">Brows will appear darker for the first 3-5 days after treatment. Mild flaking occurs around day 7 as fresh skin heals over the pigment. Full color reveals within 4 to 6 weeks, after which a perfecting touch-up is performed.</p>
                </details>
            </div>
        </div>
    </section>
