...
$pageTitle = "Nutrition & Diet <i class='text-brand font-light'>Counselling in Mpigi.</i>";
$metaTitle = "Nutrition & Diet Counselling in Mpigi | Refine Skin & Body Clinic";
$metaDescription = "Personalized nutrition plans and one-on-one diet counselling in Mpigi to support your aesthetic goals, weight loss journey, skin radiance, and overall wellness.";
$metaKeywords = "Nutrition counselling Mpigi, Dietitian Mpigi, Diet counselling Mpigi, Weight loss diet Mpigi, Skin nutrition Mpigi";
$pageDescription = "Personalized nutrition plans and one-on-one diet counselling in Mpigi to support your aesthetic goals, weight loss journey, skin radiance, and overall wellness.";
