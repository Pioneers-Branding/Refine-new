...
$pageTitle = "Nutrition & Diet <i class='text-brand font-light'>Counselling in Jinja.</i>";
$metaTitle = "Nutrition & Diet Counselling in Jinja | Refine Skin & Body Clinic";
$metaDescription = "Personalized nutrition plans and one-on-one diet counselling in Jinja to support your aesthetic goals, weight loss journey, skin radiance, and overall wellness.";
$metaKeywords = "Nutrition counselling Jinja, Dietitian Jinja, Diet counselling Jinja, Weight loss diet Jinja, Skin nutrition Jinja";
$pageDescription = "Personalized nutrition plans and one-on-one diet counselling in Jinja to support your aesthetic goals, weight loss journey, skin radiance, and overall wellness.";
