...
$pageTitle = "Non-Surgical Brazilian Butt Lift in Nansana";
$pageDescription = "Lift, round, and shape the buttocks without surgery — using a combination of muscle-building and skin-tightening technologies.";
$metaTitle = "Non-Surgical Brazilian Butt Lift Treatment in Nansana | Refine Clinic";
$metaDescription = "Seeking non-surgical brazilian butt lift treatment in Nansana? Refine Skin & Body Clinic offers advanced treatments to deeply cleanse, hydrate, and rejuvenate your skin.";
$canonicalUrl = "https://refineskinandbody.com/non-surgical-brazilian-butt-lift-in-nansana";
$metaKeywords = "Non-Surgical Brazilian Butt Lift in Nansana, Non-Surgical Brazilian Butt Lift treatment in Kampal";
?>
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/non-surgical-brazilian-butt-lift" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Non Surgical Brazilian Butt Lift</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Nansana Location</span>
            </div>
            <a href="/non-surgical-brazilian-butt-lift" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Non Surgical Brazilian Butt Lift Page</span>
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[16/10] sm:aspect-[4/3] w-full max-w-xl lg:max-w-none mx-auto gs-reveal-img-group group border border-brand/5">
                        ...
                        <img src="/assets/images/services/body-contouring/Non-Surgical-Brazilian-Butt-Lift-09.png" alt="Non Surgical Brazilian Butt Lift at Refine Skin and Body Clinic." class="w-full h-full object-cover gs-reveal-img filter grayscale-[0.2] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" loading="lazy">
                    </div>
                </div>
                    ...
                    <div class="glass-panel p-10 lg:p-12 rounded-[3rem] bg-[#1a2333]/60 backdrop-blur-2xl border border-white/10 shadow-2xl relative overflow-hidden h-full flex flex-col justify-center transform hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div class="space-y-8 relative z-10">
                            <div class="bg-white/5 p-6 rounded-3xl border border-white/5 shadow-inner">
                                ...
                                <p class="font-heading text-xl font-light text-white/80 italic">"Non-surgical treatments offer permanent results."</p>
                            </div>
                            ...
                            <div class="bg-accent/10 p-6 rounded-3xl border border-accent/20 shadow-lg relative overflow-hidden">
                                ...
                                <p class="font-heading text-2xl font-light text-white relative z-10 leading-snug">The results are impressive but temporary, necessitating touch-ups over time.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-[1600px] mx-auto px-6 lg:px-10 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-20 gs-reveal-text">
                ...
                <p class="text-brand-muted font-body text-lg font-light leading-relaxed">
                    Discover why we are the top-rated clinic for Non-Surgical Brazilian Butt Lift treatments. Here is what our patients say about their body contouring and weight loss journey.
                </p>
            </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I had the most amazing experience getting a <strong class="text-brand font-semibold">Non-Surgical Brazilian Butt Lift in Nansana</strong> at Refine Clinic. The staff is professional, and the results are truly life-changing!
                            </h4>
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Best <strong class="text-brand font-semibold">Non-Surgical Brazilian Butt Lift treatment in Nansana</strong> by far! The clinic is beautiful, and the specialists are so supportive and knowledgeable.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Absolutely loved my <strong class="text-brand font-semibold">Non-Surgical Brazilian Butt Lift treatment in Nansana</strong>! The specialists guided me through every step, and the progress has exceeded my expectations.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I feel incredibly healthy and happy. This was my first experience with <strong class="text-brand font-semibold">Non-Surgical Brazilian Butt Lift in Nansana</strong>, and the results exceeded my expectations. Highly recommend!
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Refine is the absolute best for <strong class="text-brand font-semibold">Non-Surgical Brazilian Butt Lift in Nansana</strong>. The clinic uses state-of-the-art technology, and their customized plan made all the difference.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
    ...
    <div class="max-w-[900px] mx-auto px-6">
      <div class="text-center mb-16">
        ...
        <p class="text-brand-muted font-body text-lg font-light leading-relaxed max-w-2xl mx-auto">
          Explore our comprehensive FAQ section for quick answers to common queries about Non Surgical Brazilian Butt Lift. Find the clarity you need without delay.
        </p>
      </div>
      ...
      <div class="space-y-3">
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">1. How long do the results last?</h4>
          ...
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">Results typically last between 18 to 24 months, varying based on individual factors.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">2. Is there any downtime?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">There's minimal to no downtime. Most clients resume daily activities immediately.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          ...
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">The treatment is relatively painless, with mild discomfort managed through local anesthetics.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">4. How does this differ from a surgical butt lift?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">It's less invasive, involves no incisions, and results in almost no downtime.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">5. Are there any potential side effects?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">Temporary swelling, redness, or bruising may occur but typically subsides within a week.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">6. What is the cost of Non-Surgical Brazilian Butt Lift in Nansana?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
