        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div class="grid lg:grid-cols-12 gap-16 lg:gap-24">
                ...
                <div class="lg:col-span-4">
                    <div class="sticky top-32">
                        <div class="rounded-[40px] overflow-hidden shadow-2xl mb-8 relative gs-reveal-img-group aspect-[3/4]">
                            <!-- Placeholder Image -->
                            <img src="https://images.pexels.com/photos/5327584/pexels-photo-5327584.jpeg?auto=compress&cs=tinysrgb&w=800" alt="Dr. Ahmed Ashraf" class="w-full h-full object-cover filter grayscale-[0.2] gs-reveal-img" loading="lazy">
                ...
                <div class="lg:col-span-8 gs-reveal-text">
                    ...
                    <h2 class="font-display text-4xl lg:text-5xl text-brand-deeper mb-6">International <i class="text-accent font-light">Standards.</i></h2>
