...
$pageTitle = "Myers' Plus Plenish IV Therapy in Entebbe";
...
$canonicalUrl = "https://refineskinandbody.com/myers-plus-plenish-in-entebbe";
?>
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/myers-plus-plenish" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Myers Plus Plenish</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Entebbe Location</span>
            </div>
            <a href="/myers-plus-plenish" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Myers Plus Plenish Page</span>
