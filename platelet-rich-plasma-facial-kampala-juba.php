        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid xl:grid-cols-2 gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="font-display text-5xl lg:text-6xl text-brand-deeper mb-6 leading-[1.1]">What is <br/><i class="text-accent font-light">PRP Facial in Kampala?</i></h2>
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[minmax(180px,auto)] gs-stagger-bento">
                ...
                <div class="md:col-span-2 group glass-panel p-10 rounded-[2.5rem] bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 bento-item overflow-hidden relative">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-2xl mb-4 relative z-10">Hair Thinning and Loss</h4>
                    <p class="text-base text-brand-muted font-light leading-relaxed max-w-md relative z-10">One of the most distressing aesthetic concerns for many is hair thinning or loss. Age, genetics, hormonal imbalances, or medical conditions can lead to the weakening of hair follicles.</p>
                </div>
                ...
                <div class="group glass-panel p-10 rounded-[2.5rem] bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 bento-item relative">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3">Fine Lines and Wrinkles</h4>
                    <p class="text-sm text-brand-muted font-light leading-relaxed">PRP promotes skin hydration and plumpness, smoothing wrinkles.</p>
                </div>
                ...
                <div class="group glass-panel p-10 rounded-[2.5rem] bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 bento-item relative">
                    ...
                    <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3">Acne Scars and Pigmentation</h4>
                    <p class="text-sm text-brand-muted font-light leading-relaxed">Acne scars can be a remnant of adolescent or adult acne bouts, leaving behind uneven skin textures or pigmentation.</p>
                </div>
            ...
            <div class="space-y-5">
                <div class="glass-panel rounded-3xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
                    <div class="p-8 flex justify-between items-center transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-xl pr-8 group-hover:text-accent transition-colors">1. Is the PRP Facial painful?</h4>
                    ...
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="px-8 pb-8">
                            <p class="text-brand-muted font-body text-base leading-relaxed mt-2 border-t border-brand/5 pt-6">A numbing cream is applied, making the procedure comfortable.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel rounded-3xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
                    <div class="p-8 flex justify-between items-center transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-xl pr-8 group-hover:text-accent transition-colors">2. How long is the recovery time?</h4>
                        <div class="w-12 h-12 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
                            <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
                        </div>
                    </div>
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="px-8 pb-8">
                            <p class="text-brand-muted font-body text-base leading-relaxed mt-2 border-t border-brand/5 pt-6">Minimal to no downtime; slight redness might occur but dissipates quickly.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel rounded-3xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
                    <div class="p-8 flex justify-between items-center transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-xl pr-8 group-hover:text-accent transition-colors">3. How often should one get a PRP Facial?</h4>
                        <div class="w-12 h-12 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
                            <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
                        </div>
                    </div>
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="px-8 pb-8">
                            <p class="text-brand-muted font-body text-base leading-relaxed mt-2 border-t border-brand/5 pt-6">Generally, 3 sessions with a month's gap are recommended for optimal results.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel rounded-3xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
                    ...
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="px-8 pb-8">
                            <p class="text-brand-muted font-body text-base leading-relaxed mt-2 border-t border-brand/5 pt-6">The effects can last up to 18 months, depending on individual skin and care.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel rounded-3xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
                    <div class="p-8 flex justify-between items-center transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-xl pr-8 group-hover:text-accent transition-colors">5. What is the cost of Platelet-Rich Plasma in Uganda?</h4>
                        <div class="w-12 h-12 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
                            <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
                        </div>
                    </div>
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="px-8 pb-8">
                            <p class="text-brand-muted font-body text-base leading-relaxed mt-2 border-t border-brand/5 pt-6">Platelet-Rich Plasma cost in Uganda varies depending upon several factors. The cost of Platelet-Rich Plasma at Refine Skin & Body Clinic can cost anywhere From $350.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-panel rounded-3xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
                    <div class="p-8 flex justify-between items-center transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-xl pr-8 group-hover:text-accent transition-colors">6. What is the cost of Platelet Rich Plasma Facial in Uganda?</h4>
                        <div class="w-12 h-12 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
                            <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
                        </div>
                    </div>
                    <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                        <div class="px-8 pb-8">
                            <p class="text-brand-muted font-body text-base leading-relaxed mt-2 border-t border-brand/5 pt-6">The cost for Platelet Rich Plasma Facial varies depending on your individual requirements. Please contact Refine Skin & Body Clinic for a personalized consultation and quote.</p>
                        </div>
                    </div>
                </div>
            </div>
