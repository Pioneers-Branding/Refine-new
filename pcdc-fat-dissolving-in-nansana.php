...
$pageTitle = "PCDC Fat Dissolving Injections in Nansana";
$pageDescription = "Permanent non-surgical fat reduction with PCDC (Phosphatidylcholine Deoxycholic Acid) injections for a slimmer, sculpted body.";
$metaTitle = "PCDC Fat Dissolving Treatment in Nansana | Refine Clinic";
$metaDescription = "Seeking pcdc fat dissolving treatment in Nansana? Refine Skin & Body Clinic offers advanced treatments to deeply cleanse, hydrate, and rejuvenate your skin.";
$canonicalUrl = "https://refineskinandbody.com/pcdc-fat-dissolving-in-nansana";
$metaKeywords = "PCDC Fat Dissolving in Nansana, PCDC Fat Dissolving treatment in Kampal";
?>
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/pcdc-fat-dissolving" class="hover:text-accent font-semibold text-brand-deeper transition-colors">PCDC Fat Dissolving</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Nansana Location</span>
            </div>
            <a href="/pcdc-fat-dissolving" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main PCDC Fat Dissolving Page</span>
            ...
            <div class="grid xl:grid-cols-2 gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[4/3] lg:aspect-auto lg:h-[450px] gs-reveal-img-group group border border-brand/5">
                        ...
                        <img src="/assets/images/services/body-contouring/Fat%20Dissolving-09.png" alt="Pcdc Fat Dissolving at Refine Skin and Body Clinic." class="w-full h-full object-cover gs-reveal-img filter grayscale-[0.2] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" loading="lazy">
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="space-y-8 relative z-10">
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">1.</span> Targeted Treatment
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">Precisely addresses specific areas with stubborn fat.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">2.</span> Minimally Invasive
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">A non-surgical alternative to traditional liposuction.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">3.</span> Quick Procedure
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">Each session is swift, with minimal downtime.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-8 group">
                            ...
                            <div class="glass-panel p-8 rounded-[2rem] bg-white border border-brand/5 shadow-sm hover:shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:border-accent/20 transition-all duration-500 flex-1 transform hover:-translate-y-1">
                                <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-3 flex items-center gap-3">
                                    <span class="sm:hidden text-accent font-display text-2xl">4.</span> Natural-Looking Results
                                </h4>
                                <p class="text-brand-muted font-body text-sm leading-relaxed">Gradual fat reduction for a natural body contour.</p>
                            </div>
                        </div>
    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 gs-stagger-bento">
        ...
        <div class="md:col-span-2 group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 overflow-hidden relative cursor-pointer">
          ...
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Localized Fat Deposits</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed max-w-3xl relative z-10">Ideal for areas like the chin, abdomen, thighs, and arms. Our expert team utilizes advanced, evidence-based techniques to address this effectively. We personalize every step of the process to ensure optimal, long-lasting results that harmonize with your natural aesthetics and restore your confidence.</p>
        ...
        <div class="group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 relative cursor-pointer">
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Double Chin</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed relative z-10">Reduces under-chin fat for a more defined jawline.</p>
        ...
        <div class="group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 relative cursor-pointer">
          ...
          <p class="text-base text-brand-muted font-light leading-relaxed relative z-10">Enhances body shape by targeting specific fat pockets.</p>
        ...
        <!-- 4 -->
        <div class="group glass-panel p-6 lg:p-8 rounded-3xl bg-[#faf9f6] border border-brand/5 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(var(--color-accent),0.08)] transition-all duration-500 relative cursor-pointer">
          <h4 class="font-heading font-semibold text-brand-deeper text-xl mb-2 relative z-10 pr-12">Post-Weight Loss Fine-Tuning</h4>
          <p class="text-base text-brand-muted font-light leading-relaxed relative z-10">Perfect for refining body contours after major weight loss.</p>
                    ...
                    <div class="glass-panel p-10 lg:p-12 rounded-[3rem] bg-[#1a2333]/60 backdrop-blur-2xl border border-white/10 shadow-2xl relative overflow-hidden h-full flex flex-col justify-center transform hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div class="space-y-8 relative z-10">
                            <div class="bg-white/5 p-6 rounded-3xl border border-white/5 shadow-inner">
                                ...
                                <p class="font-heading text-xl font-light text-white/80 italic">"Anyone can undergo PCDC Fat Dissolving treatments."</p>
                            </div>
                            ...
                            <div class="bg-accent/10 p-6 rounded-3xl border border-accent/20 shadow-lg relative overflow-hidden">
                                ...
                                <p class="font-heading text-2xl font-light text-white relative z-10 leading-snug">PCDC is suitable for many, but not all. A consultation with a professional, like Dr. Kotecha, is essential to determine if it's the right treatment for your specific needs.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-[1600px] mx-auto px-6 lg:px-10 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-20 gs-reveal-text">
                ...
                <p class="text-brand-muted font-body text-lg font-light leading-relaxed">
                    Discover why we are the top-rated clinic for PCDC Fat Dissolving treatments. Here is what our patients say about their body contouring and weight loss journey.
                </p>
            </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I had the most amazing experience getting a <strong class="text-brand font-semibold">PCDC Fat Dissolving in Nansana</strong> at Refine Clinic. The staff is professional, and the results are truly life-changing!
                            </h4>
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Best <strong class="text-brand font-semibold">PCDC Fat Dissolving treatment in Nansana</strong> by far! The clinic is beautiful, and the specialists are so supportive and knowledgeable.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Absolutely loved my <strong class="text-brand font-semibold">PCDC Fat Dissolving treatment in Nansana</strong>! The specialists guided me through every step, and the progress has exceeded my expectations.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                I feel incredibly healthy and happy. This was my first experience with <strong class="text-brand font-semibold">PCDC Fat Dissolving in Nansana</strong>, and the results exceeded my expectations. Highly recommend!
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
                    ...
                    <div class="swiper-slide w-full md:w-[600px]">
                        <div class="testimonial-slide-inner relative">
                            ...
                            <h4 class="font-display text-xl lg:text-2xl text-brand-deeper leading-snug mb-8 relative z-10 italic font-light">
                                Refine is the absolute best for <strong class="text-brand font-semibold">PCDC Fat Dissolving in Nansana</strong>. The clinic uses state-of-the-art technology, and their customized plan made all the difference.
                            </h4>
                            <div class="flex items-center gap-4 relative z-10 border-t border-brand/5 pt-6">
    ...
    <div class="max-w-[900px] mx-auto px-6">
      <div class="text-center mb-16">
        ...
        <p class="text-brand-muted font-body text-lg font-light leading-relaxed max-w-2xl mx-auto">
          Explore our comprehensive FAQ section for quick answers to common queries about Pcdc Fat Dissolving. Find the clarity you need without delay.
        </p>
      </div>
      ...
      <div class="space-y-3">
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">1. How long does a PCDC Fat Dissolving session last?</h4>
          ...
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">Each session typically takes about 30 to 60 minutes, depending on the treatment area.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">2. How many PCDC sessions are needed for visible results?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">The number of sessions varies depending on the individual's goals and the area being treated, often ranging from 2 to 4 sessions.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">3. Is there any special care required after a PCDC treatment?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">Post-treatment care is minimal, but it's important to follow any specific instructions provided by your clinician, such as staying hydrated.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">4. Can PCDC Fat Dissolving be used on any part of the body?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">PCDC is most effective on areas like the chin, abdomen, thighs, and arms. However, it's not suitable for every body part.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">5. Are the results of PCDC Fat Dissolving permanent?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">Once the fat cells are dissolved and eliminated by the body, they cannot return. However, maintaining results requires a healthy lifestyle.</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass-panel rounded-xl md:rounded-2xl overflow-hidden faq-item cursor-pointer group bg-white border border-brand/5 shadow-sm hover:shadow-xl hover:shadow-brand/5 hover:border-accent/30 transition-all duration-300">
          <div class="px-4 py-3 md:px-5 md:py-4 lg:p-6 flex justify-between items-center transition-colors">
            <h4 class="font-heading font-semibold text-brand-deeper text-base md:text-lg pr-4 md:pr-6 group-hover:text-accent transition-colors">6. Why choose Refine Skin and Body Clinic for PCDC Fat Dissolving?</h4>
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-surface-cool group-hover:bg-accent/10 flex items-center justify-center flex-shrink-0 transition-colors">
              <i class="fas fa-plus text-brand group-[.active]:text-accent transition-transform duration-500 transform group-[.active]:rotate-45"></i>
            </div>
          </div>
          <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="px-4 pb-3 md:px-5 md:pb-4 lg:px-6 lg:pb-6">
              <p class="text-brand-muted font-body text-sm leading-relaxed mt-0 border-t border-brand/5 pt-4">The clinic, led by Dr. Kotecha, offers personalized care, advanced techniques, and a track record of successful, satisfying results in fat dissolving treatments.</p>
            </div>
          </div>
        </div>
      </div>
