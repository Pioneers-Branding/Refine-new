        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="gs-reveal-text">
                    <h2 class="font-display text-4xl text-brand-deeper mb-6">Safe, Precise <i class="text-accent font-light">Removal.</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-8">
                        Whether for cosmetic reasons or medical necessity, our dermatologists provide expert removal of moles, warts, and other benign skin lesions. We prioritize minimal scarring and send all removed tissue for histopathological examination to rule out any abnormality.
                    </p>

                    <h3 class="font-heading font-semibold text-brand-deeper text-lg mb-4 border-b border-brand/10 pb-2">Lesions We Remove</h3>
                    <ul class="grid grid-cols-2 gap-x-4 gap-y-3 font-body text-brand-muted text-sm font-light">
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Common Moles</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Common Warts</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Genital Warts</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Plantar Warts</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Flat Warts</li>
                        <li><i class="fas fa-check text-accent mr-2 text-xs"></i> Seborrheic Keratoses</li>
                    </ul>
                </div>
            ...
            <div class="space-y-4">
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    <div class="p-6 flex justify-between items-center bg-white group-hover:bg-brand/5 transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-lg">Will mole removal leave a scar?</h4>
                    ...
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300 bg-white">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">Most removals heal with a small, flat scar that fades over time. Laser removal typically leaves the least visible mark.</p>
                    </div>
                </div>
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    <div class="p-6 flex justify-between items-center bg-white group-hover:bg-brand/5 transition-colors">
                        <h4 class="font-heading font-semibold text-brand-deeper text-lg">Are warts contagious?</h4>
                        <i class="fas fa-plus text-brand transition-transform duration-300 transform group-[.active]:rotate-45"></i>
                    </div>
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300 bg-white">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">Yes, warts are caused by HPV and can spread through skin contact. Removal helps prevent both spread and recurrence.</p>
                    </div>
                </div>
            </div>
        </div>
