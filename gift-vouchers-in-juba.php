...
$canonicalUrl = "https://refineskinandbody.com/gift-vouchers-in-juba";
?>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1 gs-reveal-text lg:pr-12">
                    ...
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-8">
                        Inside, nestled in premium cardstock, lies the key to their aesthetic journey. Physical vouchers can be collected in-clinic or delivered via premium courier service within Juba and Juba.
                    </p>
