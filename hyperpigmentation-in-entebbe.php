...
$metaTitle = "Hyperpigmentation Treatment in Entebbe | Refine Clinic";
$metaDescription = "Seeking experienced dermatologists for hyperpigmentation treatment in Entebbe? Refine Skin & Body Clinic offers advanced medical dermatology treatments.";
$canonicalUrl = "https://refineskinandbody.com/hyperpigmentation-in-entebbe";
$metaKeywords = "Hyperpigmentation Treatment in Entebbe, Hyperpigmentation Treatment treatment in Kampal";
?>
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/hyperpigmentation" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Hyperpigmentation</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Entebbe Location</span>
            </div>
            <a href="/hyperpigmentation" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Hyperpigmentation Page</span>
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative rounded-3xl overflow-hidden aspect-square border border-white/10">
                    <img src="/assets/imagesfromsite/Laser%20Skin%20Rejuvenation-09.png" alt="Laser skin treatment" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </section>
