...
$pageTitle = "Refine <i class='text-brand font-light'>IV Lounge.</i>";
$pageDescription = "Experience premium IV therapy in a luxurious, relaxing environment at Refine Skin & Body Clinic.";
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="text-section font-display text-brand-deeper mb-6 leading-[1.1]">Welcome to the <br/><i class="text-accent font-light">Refine IV Lounge</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        Discover our comprehensive range of bespoke intravenous therapies designed to optimize your health, boost your energy, and enhance your natural beauty from the inside out.
                    </p>
