...
$pageTitle = "Mobile <i class='text-brand font-light'>IV Service.</i>";
$pageDescription = "Premium IV therapy delivered directly to your home, hotel, or office in Entebbe and Juba.";
    ...
    <div class="bg-surface-warm/60 border-b border-brand/5 py-2.5 relative z-20">
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-wrap items-center justify-between text-xs text-brand-muted gap-2">
            <div class="flex items-center gap-2">
                ...
                <a href="/mobile-iv-service" class="hover:text-accent font-semibold text-brand-deeper transition-colors">Mobile IV Service</a>
                <span class="text-gray-300">/</span>
                <span class="text-accent font-medium">Entebbe Location</span>
            </div>
            <a href="/mobile-iv-service" class="inline-flex items-center gap-1.5 text-accent font-semibold hover:underline">
                <span>View Main Mobile IV Service Page</span>
        ...
        <div class="max-w-[1400px] mx-auto px-6 lg:px-10 relative z-10">
            <div class="grid xl:grid-cols-2 gap-16 xl:gap-24 items-center">
                <div class="gs-reveal-text">
                    ...
                    <h2 class="text-section font-display text-brand-deeper mb-6 leading-[1.1]">What is our <br/><i class="text-accent font-light">Mobile IV Service?</i></h2>
                    <p class="text-brand-muted font-body text-lg font-light leading-relaxed mb-10 max-w-xl">
                        Enjoy the benefits of our bespoke IV therapies in the comfort and privacy of your own space. Our expert medical team brings the Refine IV Lounge experience to you.
                    </p>
