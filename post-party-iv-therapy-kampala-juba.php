...
<main class="pt-20">
    ...
    <section class="py-16 bg-white border-b border-brand/5">
        <div class="max-w-[1000px] mx-auto px-6 text-center gs-reveal-fade">
            <h2 class="font-display text-3xl text-brand-deeper mb-6">Bounce Back, <i class="text-accent font-light">Fast.</i></h2>
            <p class="text-brand-muted font-body text-lg font-light leading-relaxed">
                Woke up feeling the night before? The Post-Party IV is the fastest way to recover. A targeted blend of hydration, electrolytes, B vitamins, and liver-supporting nutrients rehydrates your body, restores balance, and gets you back to feeling human in under an hour.
            </p>
        </div>
    </section>
            ...
            <div class="space-y-4">
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    ...
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">Most clients feel 70–80% better within 30–60 minutes of completing the drip.</p>
                    </div>
                </div>
                <div class="glass-panel rounded-2xl overflow-hidden faq-item cursor-pointer group border border-brand/5">
                    <div class="p-6 flex justify-between items-center bg-white/50 group-hover:bg-white transition-colors">
                    ...
                    <div class="faq-content h-0 overflow-hidden px-6 pb-0 group-[.active]:pb-6 transition-all duration-300">
                        <p class="text-brand-muted font-body text-sm leading-relaxed mt-2 border-t border-brand/5 pt-4">Yes — our mobile IV service delivers the Post-Party drip to your home, hotel, or office across Kampala and Juba.</p>
                    </div>
                </div>
            </div>
        </div>
